	...
	<div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
		...
		<div className="space-y-4 mt-5">
			<details className="w-full border rounded-lg">
				<summary className="px-4 py-6 focus:outline-none focus-visible:ring-blue-600">Difference between SQL and NoSQL</summary>
			...
			<details className="w-full border rounded-lg">
				<summary className="px-4 py-6 focus:outline-none focus-visible:ring-blue-600">What is JWT, and how does it work?</summary>
			...
			<details className="w-full border rounded-lg">
				<summary className="px-4 py-6 focus:outline-none focus-visible:ring-blue-600">What is the difference between javascript and NodeJS?</summary>
			...
			<details className="w-full border rounded-lg">
				<summary className="px-4 py-6 focus:outline-none focus-visible:ring-blue-600">How does NodeJS handle multiple requests at the same time?</summary>
