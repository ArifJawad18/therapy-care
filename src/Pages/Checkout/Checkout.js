    ...
    <div>
      <div className=" mt-5 container mx-auto space-y-12">
        <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
          <img
            src="https://www.summithealth.com/sites/default/files/2021-05/Hand%20Therapy.jpg"
            alt=""
          ...
          <div className="flex flex-col justify-center flex-1 p-6 bg-gray-50">
            ...
            <p className="my-6 text-gray-600">
              Manage and reduce joint pain. Increase range of motion, function,
              dexterity, and strength. Desensitize nerves following injury or
              trauma. Provide education and training to adapt to daily
