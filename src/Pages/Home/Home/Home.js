    ...
    <div>
      ...
      <div>
        <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row-reverse">
          <img
            src="https://images.unsplash.com/photo-1549576490-b0b4831ef60a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
            alt=""
          ...
          <div className="flex flex-col justify-center flex-1 p-6 bg-gray-50">
            ...
            <p className="my-6 text-gray-600">
              ...
              Improving overall strength and coordination. ...Reducing the
              dependency on medicines. ... Boosting cardiovascular functioning
              and lung capacity. ... Managing and preventing sports related
              injuries. ... Staying fit at all ages and phases
            </p>
          </div>
        </div>
      </div>
        ...
        <section className="py-20 bg-gray-100 text-gray-800">
          <div className="container px-4 mx-auto">
            <div className="max-w-2xl mx-auto mb-16 text-center">
              <span className="font-bold tracking-wider uppercase text-blue-600">
                Pricing
              </span>
